...
Plugin 'shougo/ddc-ui-pum'
Plugin 'shougo/ddc-ui-native'
Plugin 'shougo/ddc-matcher_head'
Plugin 'shougo/ddc-sorter_rank'
Plugin 'shougo/ddc-source-cmdline'
Plugin 'shougo/ddc-source-around'
Plugin 'shougo/ddc-source-cmdline-history'
Plugin 'preservim/nerdtree'
"Plugin 'abhishekgahlot/vim-clangd'
"Plugin 'shougo/ddc-source-lsp'
...
nmap wm :call ToggleNerdTree()<CR>
